...
%If the class is in the same module, it may come from the module that the one corresponding to the current loader. So the class loader should delegate the dependent class loaders to resolve the class for it
...
%Each class loader only loads classes of corresponding sub modules.
So reconstruction in class loaders reduces the granularity of the update and narrows the scope of the hot deployment.

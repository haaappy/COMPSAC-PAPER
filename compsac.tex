...
%However, the standard class loader\cite{standard_cl} architecture  be destroyed.
...
\section{Dependency Reconstruction in Application Servers}
...
\section{Dependency Reconstruction with class loaders}
